    ...
    return (
        <div className="fixed bottom-8 right-8 z-40">
            <button
                ...
                onClick={onClick}
                className="fab-button group flex items-center justify-center size-14 bg-[#0d59f2] text-white rounded-full shadow-lg shadow-[#0d59f2]/30 hover:shadow-[#0d59f2]/50 hover:scale-110 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-[#0d59f2]/20"
            >
